...
let food = ('vietnamese ' + 'pho');
// 9 - Create a variable called `pets` and set it to the value of the number of pets you have
let pets = 1;
sentence = 'pets total 1';
console.log('pets total 1');
...
let LuckyNumbers = 1;
switch(LuckyNumbers) {
    case 1: LuckyNumbers = 1;console.log('First is the worst');
    break;
    case 2: LuckyNumbers = 2;console.log('Second is the best');
    break;
    case 3: LuckyNumbers = 3; console.log('Third is the one with the polka dot dress');
    break;
